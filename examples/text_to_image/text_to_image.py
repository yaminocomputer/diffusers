...
def main():
    ...
    # Load the models for stable diffusion
    ...
    if args.dataset_name is not None:
        ...
        train_dataset = load_dataset("imagefolder", data_dir=args.train_data_dir, cache_dir=args.cache_dir, split="train")
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("text_to_image", config=vars(args))
